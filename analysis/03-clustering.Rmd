...
```{r}
var <- c("cluster_walktrap_integrated", "sum", "detected", "altexps_ERCC_percent")
```
...
```{r}
var <- c("cluster_louvain_integrated", "sum", "detected", "altexps_ERCC_percent")
```
...
```{r}
var <- c("cluster_kmeans_integrated", "sum", "detected", "altexps_ERCC_percent")
```
...
```{r}
var <- c("cluster_hclust_integrated", "sum", "detected", "altexps_ERCC_percent")
```
