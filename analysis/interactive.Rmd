...
```{r}
file.copy("output/04-marker-detection.rds", "shiny/batch/data.rds", overwrite = TRUE)
```
...
<!-- Create iSEE directory for atlas data: -->

<!-- ```{r} -->
<!-- dir.create("shiny/atlas", showWarnings = FALSE, mode = "0755") -->
<!-- ``` -->

<!-- Copy atlas data to iSEE directory: -->

<!-- ```{r} -->
<!-- file.copy("output/02-atlas-integration.rds", "shiny/atlas/data.rds", overwrite = TRUE) -->
<!-- ``` -->

<!-- Write code to iSEE application file: -->

<!-- ```{cat, engine.opts = list(file = "shiny/atlas/app.R"), class.source = "r"} -->
<!-- # Load required packages -->
<!-- library(iSEE) -->
<!-- library(SingleCellExperiment) -->
<!-- library(BiocSingular) -->
...
<!-- # Create iSEE object -->
<!-- iSEE(sce, appTitle = "LPMP_NMP_ATLAS", colormap = ecm) -->
<!-- ``` -->

<!-- Deploy the iSEE application to the shiny server: -->

<!-- ```{r} -->
<!-- deployApp(appDir = "shiny/atlas", appName = "LPMP_NMP_ATLAS", appTitle = "LPMP_NMP_ATLAS", launch.browser = FALSE, forceUpdate = TRUE) -->
<!-- ``` -->

<!-- Allocate more memory to the iSEE application: -->

<!-- ```{r} -->
<!-- configureApp(appName = "LPMP_NMP_ATLAS", appDir = "shiny/atlas", size = "xxxlarge") -->
<!-- ``` -->
